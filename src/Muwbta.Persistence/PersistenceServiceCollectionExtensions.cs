...
public static class PersistenceServiceCollectionExtensions
{
    ...
    /// </summary>
    public static IServiceCollection AddMuwbtaPersistence(
        ...
        string connectionString)
    {
        ...
        services.AddPooledDbContextFactory<MuwbtaDbContext>(options =>
            options.UseNpgsql(
                dataSource,
                builder => builder.MigrationsAssembly(typeof(MuwbtaDbContext).Assembly.GetName().Name)));
