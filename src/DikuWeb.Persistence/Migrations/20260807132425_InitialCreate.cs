        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    template_name = table.Column<string>(type: "text", nullable: false),
                    level = table.Column<int>(type: "integer", nullable: false),
                    room_key = table.Column<string>(type: "text", nullable: false),
                    resolved_stats = table.Column<Dictionary<string, object>>(type: "jsonb", nullable: false),
                    spawn_multipliers = table.Column<Dictionary<string, decimal>>(type: "jsonb", nullable: false),
                    resolved_xp = table.Column<int>(type: "integer", nullable: false),
                    resolved_gold = table.Column<int>(type: "integer", nullable: false),
                    vitals_health = table.Column<int>(type: "integer", nullable: false),
                    vitals_health_max = table.Column<int>(type: "integer", nullable: false),
                    vitals_focus = table.Column<int>(type: "integer", nullable: false),
                    vitals_focus_max = table.Column<int>(type: "integer", nullable: false),
                    vitals_stamina = table.Column<int>(type: "integer", nullable: false),
                    vitals_stamina_max = table.Column<int>(type: "integer", nullable: false),
                    combat_state = table.Column<int>(type: "integer", nullable: false),
                    current_target = table.Column<string>(type: "text", nullable: true),
                    state = table.Column<Dictionary<string, object>>(type: "jsonb", nullable: false)
                },
                constraints: table =>
                {
