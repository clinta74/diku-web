using Muwbta.Playtest.Load;

namespace Muwbta.Playtest.Tests;
    ...
    public void The_window_is_the_difference_between_two_scrapes()
    {
        ...
        var after = MetricsSnapshot.Read(
            Exposition
                ...
                .Replace("_count{otel_scope_name=\"Muwbta.Engine\"} 1000", "_count{otel_scope_name=\"Muwbta.Engine\"} 2000", StringComparison.Ordinal),
